...
export default function ProjectOverview({ setActiveTab }) {
    ...
    const publishedPercentage = totalTemplates > 0 ? Math.round((publishedTemplates / totalTemplates) * 100) : 0;
    const draftPercentage = totalTemplates > 0 ? Math.round((draftTemplates / totalTemplates) * 100) : 0;
        ...
        <ConfigProvider
            theme={{
                ...
                token: {
                    ...
                    colorBgBase: isDark ? "#081521" : "#F5F7FA",
                    colorBgLayout: isDark ? "#081521" : "#F5F7FA",
                    colorBgContainer: isDark ? "#102638" : "#FFFFFF",
                    colorBorder: isDark ? "#203B4D" : "#E5E7EB",
                    borderRadius: 8,
                },
            }}
        >
            <div
                style={{
                    minHeight: "100vh",
                    background: isDark ? "#081521" : "#F5F7FA",
                    padding: 24,
                }}
            >
                            ...
                            >
                                <Space direction="vertical" size={0} style={{ width: "100%", }}>
                                    {templates.map((template, index) => (
                                        <div key={template.id}>
                                            <Flex justify="space-between" align="center" gap={16} style={{ padding: "14px 4px", }}>
                        ...
                        <Col xs={24} lg={8}>
                            ...
                            >
                                <Space direction="vertical" size={20} style={{ width: "100%", }}>
                                    ...
                                    <Flex justify="space-between" style={{ marginTop: 28, }}>
                        ...
                        <Flex justify="space-between" align="center" wrap="wrap" gap={16}>
                            <Space>
                                ...
                                <Space direction="vertical" size={0}>
                                    ...
                                    <Text type="secondary">Your project is configured and ready for template managment.</Text>
                                </Space>
                            </Space>
